...
# For navigation
dir1 <- "data/ISIMIP3a/reference_cal/distributions"
dir2 <- paste0("data/ISIMIP3a/reference_cal/relative/", args$scenario)
...
pdates <- read_csv("data/ISIMIP3a/reference_cal/season_parameters.csv", 
                   col_types = cols()) %>% 
  select(County, PDAY)
...
cl <- makeCluster(20L, type = "FORK", 
                  outfile = paste0("logs/reference_", args$scenario, 
                                   ".log"))
